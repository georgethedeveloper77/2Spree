...
import 'package:spree/widgets/FullImageWidget.dart';
...
class ChatScreenState extends State<ChatScreen> {
  ...
  readLocal() async {
    ...
    if (id.hashCode <= receiverId.hashCode) {
      chatId = '$id-$receiverId'; //get unique id
    } else {
  ...
  createLoading() {
    return Positioned(
      child: isLoading ? LoadingType1() : Container(),
    );
  }
        ...
        child: Column(
          children: <Widget>[
            ...
            isLastMsgLeft(index)
                ? Container(
                    child: Text(
                      DateFormat("dd MMM, yyy - hh:mm:aa").format(
            ...
            child: Container(
              child: TextField(
                ...
                decoration: InputDecoration.collapsed(
                  hintText: "This is under Construction👷👷👷",
